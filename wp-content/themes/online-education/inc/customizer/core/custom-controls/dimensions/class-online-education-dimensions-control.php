 ...
 *
 * @package online-education
 *
 * @see WP_Customize_Control
 */

/**
 * Class Online_Education_Dimensions_Control
 */
class Online_Education_Dimensions_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-dimensions';
